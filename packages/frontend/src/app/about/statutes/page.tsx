...
export default function About() {
    return (
        <>
            ...
            <h2>OBS: Endringer fra 2021 ikke ajourført.</h2>
            <p>
            ...
            <p>
                ...
                Virksomheten
                bygger på forutsetningene i Stortingets vedtak i 2004 (innst.S.nr.128) om digitalt bakkenett for
                fjernsyn.
            </p>
            ...
            <p>
                ...
                flater for
                enkeltprogrammer. Intet enkeltmedlem skal kunne tildeles mer enn én times fast sendetid pr dag.
                Sendetidspunkt
            ...
            <p>
                ...
                31. mars
                hvert år. Det skal kalles inn til ekstraordinært Årsmøte dersom minst 3 styremedlemmer eller 2/3 av
                medlemmene
                krever det.
            </p>
            ...
            <ol>
                ...
                <ol style={{listStyleType: "lower-alpha"}}>
                    ...
                    <li>Valgkomite - bestående av 3 medlemmer, hvorav ett medlem kan være styremedlem i det sittende
                        styret
                    </li>
            ...
            <p>
                ...
                styret i
                Foreningen Frikanalen og alle tilsluttede medlemmer minst to måneder før Årsmøtet. Til oppløsning kreves
                3⁄4
