!(function (e, t) {
  ...
  class r {
    ...
    update() {
      ...
      for (let n, i, c = 0; c < this._ids.length; c++) {
        ...
        let h = 0;
        for (
          let e = 0, t = this._hashKey(s, d);
          e < this._hashSize && ((h = l[(t + e) % this._hashSize]), -1 === h || h === a[h]);
          e++
        );
        h = r[h];
        let b,
        ...
        let w = a[p];
        for (; (b = a[w]), f(s, d, t[2 * w], t[2 * w + 1], t[2 * b], t[2 * b + 1]); )
          (g = this._addTriangle(w, u, b, o[u], -1, o[w])), (o[u] = this._legalize(g + 2)), (a[w] = w), E--, (w = b);
        if (p === h)
          for (; (b = r[p]), f(s, d, t[2 * b], t[2 * b + 1], t[2 * p], t[2 * p + 1]); )
            (g = this._addTriangle(b, u, p, -1, o[p], o[b])),
              this._legalize(g + 2),
              (o[b] = g),
              (a[p] = p),
              E--,
              (p = b);
        (this._hullStart = r[u] = p),
          (a[p] = r[w] = u),
          (a[u] = w),
          (l[this._hashKey(s, d)] = u),
          (l[this._hashKey(t[2 * p], t[2 * p + 1])] = p);
      }
  ...
  function c(e, t, r, n) {
    if (n - r <= 20)
      ...
      (e[r + 1] = e[f]),
        (e[f] = o),
        n - a + 1 >= f - r ? (c(e, t, a, n), c(e, t, r, f - 1)) : (c(e, t, r, f - 1), c(e, t, a, n));
    }
  }
  function l(e, t, r) {
    const n = e[t];
      ...
      e.exports = (function () {
        ...
        var je = 18,
          ...
          Ye = function (e, t, r) {
            return (
              ...
              (r = $e(r)),
              [
                De((0.4124564 * e + 0.3575761 * t + 0.1804375 * r) / Be),
                De((0.2126729 * e + 0.7151522 * t + 0.072175 * r) / Fe),
                De((0.0193339 * e + 0.119192 * t + 0.9503041 * r) / Te),
              ]
            );
          },
          We = function () {
          ...
          Je = function () {
            ...
            return (
              ...
              (a = Te * Xe(a)),
              [
                He(3.2404542 * r - 1.5371385 * n - 0.4985314 * a),
                He(-0.969266 * r + 1.8760108 * n + 0.041556 * a),
                He(0.0556434 * r - 0.2040259 * n + 1.0572252 * a),
                e.length > 3 ? e[3] : 1,
              ]
            );
          },
          ...
          c.autodetect.push({
            ...
            test: function () {
              ...
              if (
                ((e = St(e, "rgba")),
                "array" === Pt(e) &&
                  (3 === e.length || (4 === e.length && "number" == Pt(e[3]) && e[3] >= 0 && e[3] <= 1)))
              )
                return "rgb";
            },
          });
            ...
            return (
              a < 66
                ? ((t = 255),
                  ...
                  (n =
                    a < 20 ? 0 : 0.8274096064007395 * (n = a - 10) - 254.76935184120902 + 115.67994401066147 * Et(n)))
                : ((t = 351.97690566805693 + 0.114206453784165 * (t = a - 55) - 40.25366309332127 * Et(t)),
                  (r = 325.4494125711974 + 0.07943456536662342 * (r = a - 50) - 28.0852963507957 * Et(r)),
                  (n = 255)),
              [t, r, n, 1]
            );
          },
        ...
        var Ct = function (e, t, r) {
          ...
          qt = function (e, t, r) {
            ...
            var f = n[0] || "lrgb";
            if ((zt[f] || n.length || (f = Object.keys(zt)[0]), !zt[f]))
              throw new Error("interpolation mode " + f + " is not defined");
            return (
              "object" !== It(e) && (e = new h(e)),
              "object" !== It(t) && (t = new h(t)),
        ...
        (zt.lrgb = function (e, t, r) {
          var n = e._rgb,
            ...
            u = i[2];
          return new h(
            $t(Dt(a, 2) * (1 - r) + Dt(c, 2) * r),
            $t(Dt(f, 2) * (1 - r) + Dt(l, 2) * r),
            $t(Dt(o, 2) * (1 - r) + Dt(u, 2) * r),
            "rgb"
          );
        }),
        ...
        var Yt = function (e, t, r, n) {
            ...
            return (
              ...
              "h" === n.substr(0, 1) &&
                ((c = (a = o)[0]), (u = a[1]), (d = a[2]), (l = (f = i)[0]), (s = f[1]), (b = f[2])),
              isNaN(c) || isNaN(l)
                ? isNaN(c)
                  ? isNaN(l)
                    ? (g = Number.NaN)
        ...
        var Vt = i.clip_rgb,
          ...
          er = function (e, t) {
            ...
            return (
              (n[0] = Ht(n[0])), (n[1] = Ht(n[1])), (n[2] = Ht(n[2])), n[3] > 0.9999999 && (n[3] = 1), new h(Vt(n))
            );
          },
          tr = i.type,
          rr = Math.pow,
              ...
              v = function (e) {
                if (
                  ((e = e || ["#fff", "#000"]) &&
                    "string" === tr(e) &&
                    p.brewer &&
                    p.brewer[e.toLowerCase()] &&
                    (e = p.brewer[e.toLowerCase()]),
                  "array" === tr(e))
                ) {
            ...
            return (
                  ...
                  (y = d
                    ? function (e) {
                        for (
                          ...
                          n && (o *= -1),
                            o < 0 ? ((i = e), (e += 0.5 * (c - e))) : ((c = e), (e += 0.5 * (i - e))),
                            (a = w(e, !0).lab()[0]),
                            (o = a - f);
                        return e;
                      }
              ...
              (_.colors = function (t, r) {
                ...
                if (0 === arguments.length) n = c.slice(0);
                  ...
                  var l = [];
                  if (i && i.length > 2)
                    for (var u = 1, s = i.length, d = 1 <= s; d ? u < s : u > s; d ? u++ : u--)
                      l.push(0.5 * (i[u - 1] + i[u]));
                  else l = a;
                  n = l.map(function (e) {
                    return _(e);
                  });
        ...
        return (
          ...
          (p.cubehelix = function (e, t, r, n, a) {
            ...
            var i = function (i) {
              ...
              return p(
                sr([
                  255 * (l + u * (-0.14861 * s + 1.78277 * d)),
                  255 * (l + u * (-0.29227 * s - 0.90649 * d)),
                  255 * (l + u * (1.97294 * s)),
                  1,
                ])
              );
          ...
          (p.deltaE = function (e, t, r, n) {
            ...
            var y =
                v >= 164 && v <= 345
                  ? 0.56 + Pr(0.2 * Ar((Er * (v + 168)) / 180))
                  : 0.36 + Pr(0.4 * Ar((Er * (v + 35)) / 180)),
              m = d * d * d * d,
              w = Nr(m / (m + 1900)),
              k = g * (w * y + 1 - w),
              _ = d - b,
  ...
  const p = "undefined" != typeof window && "undefined" != typeof document,
    ...
    v = (e, t = {}, r, n) => {
      ...
      return (
        Object.keys(t).forEach((e) => void 0 !== t[e] && a.setAttribute(e, t[e])),
        r && r.forEach((e) => a.appendChild(e)),
        a
      );
    },
    y = (e, t = {}, r) => ({
  ...
  class m {
    constructor(e, t, r) {
      b(this, "_toSVG", (e, t, r = {}) => {
        ...
        return n(
          "svg",
          { xmlns: a.includeNamespace ? "http://www.w3.org/2000/svg" : void 0, width: c, height: l },
          s,
          t
        );
      }),
        ...
        b(this, "toCanvas", (e, t = {}) => {
          const r = { ...{ scaling: !!p && "auto", applyCssScaling: !!p }, ...t },
            ...
            o =
              e ||
              ((i = f.width), (c = f.height), Object.assign(document.createElement("canvas"), { width: i, height: c }));
          var i, c;
          ...
          if (r.scaling) {
            ...
            1 !== e
              ? ((o.width = f.width * e),
                (o.height = f.height * e),
                r.applyCssScaling && ((o.style.width = f.width + "px"), (o.style.height = f.height + "px")))
              : ((o.width = f.width),
                (o.height = f.height),
                r.applyCssScaling && ((o.style.width = ""), (o.style.height = ""))),
              l.scale(e, e);
          }
          const u = (e, t, r) => {
          ...
          return (
            ...
            a.forEach((e) =>
              u(e, f.fill && { color: e.color }, f.strokeWidth > 0 && { color: e.color, width: f.strokeWidth })
            ),
            o
          );
        }),
