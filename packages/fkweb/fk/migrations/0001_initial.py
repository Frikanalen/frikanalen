...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vod_publish",
                    models.BooleanField(
                        default=False, verbose_name="Present video format to video on demand?"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("videos", "videos"), ("organization", "organization")],
                        max_length=32,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "upload_token",
                    models.CharField(
                        blank=True, default="", help_text="Code for upload", max_length=32
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_time",
                    models.DateTimeField(
                        auto_now_add=True, help_text="Time the video file was created", null=True
                    ),
                ),
                (
                    "format",
        ...
        migrations.AddField(
            ...
            name="video",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="fk.Video"
            ),
        ),
        migrations.AddField(
            model_name="asrun",
