...
urlpatterns = [
    ...
    re_path(r"^api/user/login$", api.auth.views.UserLogin.as_view(), name="api-user-login"),
    re_path(
        r"^api/user/logout$",
        api.auth.views.UserLogout.as_view(),
        name="api-user-logout",
    ),
    re_path(r"^api/user$", api.auth.views.UserDetail.as_view(), name="api-user-detail"),
    re_path(
        r"^api/obtain-token$",
    ...
    re_path(r"^api/videos/$", api.video.views.VideoList.as_view(), name="api-video-list"),
    re_path(
