...
class PermissionsTest(APITestCase):
    ...
    def test_nuug_user_reading_all_pages_from_root_expecting_status(self):
        pages = [
            ...
            ),  # FIXME: Should return 200 or 401?
    ...
    def test_anonymous_can_not_detail_video_upload_token(self):
        ...
        for id in videos:
            ...
            self.assertEqual({"detail": "Authentication credentials were not provided."}, r.data)
    ...
    def test_anonymous_cannot_add(self):
        ...
        error_msg = {"detail": "Authentication credentials were not provided."}
        self.assertEqual([(p, status.HTTP_403_FORBIDDEN, error_msg) for p in list_pages], results)
    ...
    def test_anonymous_cannot_edit(self):
        ...
        error_msg = {"detail": "Authentication credentials were not provided."}
        self.assertEqual([(p, status.HTTP_403_FORBIDDEN, error_msg) for p in detail_pages], results)
    ...
    def test_nuug_user_can_add_things(self):
        ...
        tests = [
            ...
            (
                ...
                {"id": 3, "video": 1, "duration": "00:00:00.100000"},
                status.HTTP_201_CREATED,
            ),
            (
                reverse("asrun-list"),
    ...
    def test_staff_user_can_add_things(self):
        ...
        tests = [
            ...
            (
                ...
                {"id": 3, "video": 1, "duration": "00:00:13.100000"},
                status.HTTP_201_CREATED,
            ),
            (
                reverse("asrun-list"),
    ...
    def _helper_test_add_things(self, tests):
        for test_num, test in enumerate(tests):
            ...
            self.assertEqual(response_obj, {k: r.data[k] for k in list(response_obj.keys())})
