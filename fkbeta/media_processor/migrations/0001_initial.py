...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Task'
        db.create_table(u'media_processor_task', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fk.VideoFile'])),
            ('target_format', self.gf('django.db.models.fields.IntegerField')()),
            ('parameters', self.gf('django.db.models.fields.CharField')(max_length=4096, blank=True)),
            ('result', self.gf('django.db.models.fields.CharField')(max_length=4096, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'media_processor', ['Task'])


    def backwards(self, orm):
        # Deleting model 'Task'
        db.delete_table(u'media_processor_task')
    ...
    models = {
        ...
        u'media_processor.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parameters': ('django.db.models.fields.CharField', [], {'max_length': '4096', 'blank': 'True'}),
            'result': ('django.db.models.fields.CharField', [], {'max_length': '4096', 'blank': 'True'}),
            'source_file': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fk.VideoFile']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'target_format': ('django.db.models.fields.IntegerField', [], {})
        }
    }
