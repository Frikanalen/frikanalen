...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fk_weeklyslot', (
        ...
        db.send_create_signal(u'fk', ['WeeklySlot'])

        # Adding model 'SchedulePurpose'
        db.create_table(u'fk_schedulepurpose', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fk.Organization'], null=True)),
        ))
        db.send_create_signal(u'fk', ['SchedulePurpose'])

        # Adding M2M table for field direct_videos on 'SchedulePurpose'
        m2m_table_name = db.shorten_name(u'fk_schedulepurpose_direct_videos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('schedulepurpose', models.ForeignKey(orm[u'fk.schedulepurpose'], null=False)),
            ('video', models.ForeignKey(orm[u'fk.video'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'fk_weeklyslot')

        # Deleting model 'SchedulePurpose'
        db.delete_table(u'fk_schedulepurpose')

        # Removing M2M table for field direct_videos on 'SchedulePurpose'
        db.delete_table(db.shorten_name(u'fk_schedulepurpose_direct_videos'))
    ...
    models = {
        ...
        u'fk.schedulepurpose': {
            'Meta': {'object_name': 'SchedulePurpose'},
            'direct_videos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['fk.Video']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'fk.weeklyslot': {
            'Meta': {'object_name': 'WeeklySlot'},
            'day': ('django.db.models.fields.IntegerField', [], {}),
            'duration': ('fk.fields.MillisecondField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'purpose': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fk.SchedulePurpose']", 'null': 'True', 'blank': 'True'}),
