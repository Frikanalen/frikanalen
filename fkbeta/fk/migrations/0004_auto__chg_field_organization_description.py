...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'Organization', 'description', self.gf('django.db.models.fields.TextField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Organization.description'
        db.alter_column(u'Organization', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
