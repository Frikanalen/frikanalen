...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.header'
        db.alter_column(u'Video', 'header', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'fk.video': {
            ...
            'header': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True'}),
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
