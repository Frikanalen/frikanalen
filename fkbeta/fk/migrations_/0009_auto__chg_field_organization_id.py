...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.id'
        db.alter_column(u'Organization', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Organization.id'
        db.alter_column(u'Organization', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
    ...
    models = {
        ...
        'fk.userprofile': {
            ...
            'home_city': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
