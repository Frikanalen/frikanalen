...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoFile.old_filename'
        db.alter_column('fk_videofile', 'old_filename', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'VideoFile.filename'
        db.alter_column('fk_videofile', 'filename', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Video.header'
        db.alter_column(u'Video', 'header', self.gf('django.db.models.fields.TextField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'VideoFile.old_filename'
        db.alter_column('fk_videofile', 'old_filename', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'VideoFile.filename'
        db.alter_column('fk_videofile', 'filename', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Video.header'
        db.alter_column(u'Video', 'header', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
