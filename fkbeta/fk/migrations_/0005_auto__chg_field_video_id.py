...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'Video', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Video.id'
        db.alter_column(u'Video', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
