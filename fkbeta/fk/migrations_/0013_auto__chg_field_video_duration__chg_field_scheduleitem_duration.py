...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'Video', 'duration', self.gf('fk.fields.MillisecondField')())

        # Changing field 'Scheduleitem.duration'
        db.alter_column(u'ScheduleItem', 'duration', self.gf('fk.fields.MillisecondField')())

    def backwards(self, orm):

        # Changing field 'Video.duration'
        db.alter_column(u'Video', 'duration', self.gf('fields.MillisecondField')())

        # Changing field 'Scheduleitem.duration'
        db.alter_column(u'ScheduleItem', 'duration', self.gf('fields.MillisecondField')())
